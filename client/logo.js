...
Template.logo.onRendered(function() {
  var songs = $('.song');
  TweenLite.to(songs, 2, {width: "10px"});
  tl = new TimelineMax({paused:true, repeat:-1});
  tl.to('#logo-circle', EASE_DURATION, {scale:0.2, transformOrigin:"center center", ease:EASE_FUNCTION})
    .to('#logo-circle', EASE_DURATION, {scale:1, transformOrigin:"center center", ease:EASE_FUNCTION});
